...
import javax.inject.Inject
    ...
    class GetTripRequestByTripIdAndUserUuidUseCase @Inject constructor(
    private val repository: TripRequestRepository
) {
    suspend operator fun invoke(tripId: Long, userUuid: String): Result<TripRequest> {
        return repository.getRequestByTripIdAndUserUuid(tripId, userUuid)
    }
}