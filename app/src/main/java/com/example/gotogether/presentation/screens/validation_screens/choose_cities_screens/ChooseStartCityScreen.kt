    ...
    Box(
        ...
        if (locationState.isLoading) {
            ...
            locationState.locations?.onSuccess { locations ->
                ...
                var selectedRegion by remember { mutableStateOf<String?>(ChosenRoute.fromCityAdminName) }
                var selectedCity by remember { mutableStateOf<String?>(ChosenRoute.fromCityName) }
